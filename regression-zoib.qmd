...
See an example of [ordered beta regression in action here](https://stats.andrewheiss.com/compassionate-clam/notebook/ordbeta.html) or [here](https://dibsmethodsmeetings.github.io/ordered-beta/) or [see the official tutorial here](https://cran.r-project.org/web/packages/ordbetareg/vignettes/package_introduction.html).
